...
%prep
%setup -q -n acme-1.14.0
cd %{_builddir}/acme-1.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617807902
...
cp %{_builddir}/acme-1.14.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
