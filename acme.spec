...
Source0  : https://files.pythonhosted.org/packages/25/ad/4255d402492f0fcbedae5938918be3df25bf6611b12f0a9b621041b83c69/acme-1.21.0.tar.gz
...
%prep
%setup -q -n acme-1.21.0
cd %{_builddir}/acme-1.21.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636038181
...
cp %{_builddir}/acme-1.21.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
