...
%prep
%setup -q -n acme-1.15.0
cd %{_builddir}/acme-1.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620310272
...
cp %{_builddir}/acme-1.15.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
