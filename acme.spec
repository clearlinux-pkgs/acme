...
Source0  : https://files.pythonhosted.org/packages/cd/69/d8f1e2ae4e6d54b7a8d26026a0bccbeb58141918d324d9315b588b52be19/acme-1.22.0.tar.gz
...
%prep
%setup -q -n acme-1.22.0
cd %{_builddir}/acme-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638958543
...
cp %{_builddir}/acme-1.22.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
